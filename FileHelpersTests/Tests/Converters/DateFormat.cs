...
namespace FileHelpersTests.Converters
{
	...
	public class DateFormat
	{
		...
		public void DiferentSpanishFormat()
		{
			...
			DateFormatType1[] res = (DateFormatType1[]) Common.ReadTest(engine, @"Good\DateFormat1.txt");
		...
		public void DiferentEnglishFormat()
		{
			...
			DateFormatType2[] res = (DateFormatType2[]) Common.ReadTest(engine, @"Good\DateFormat2.txt");
