...
namespace FileHelpersTests.Converters
{
	...
	public class EnumConverter
	{
		...
		public void EnumSingleCase()
		{
			...
			EnumType2[] res = (EnumType2[]) Common.ReadTest(engine, @"Good\EnumConverter2.txt");
		...
		public void EnumexplicitConverter()
		{
			...
			EnumType3[] res = (EnumType3[]) Common.ReadTest(engine, @"Good\EnumConverter2.txt");
		...
		public void EnumMulticase()
		{
			...
			EnumType1[] res = (EnumType1[]) Common.ReadTest(engine, @"Good\EnumConverter1.txt");
		...
		public void EnumValueNotFound()
		{
			...
			EnumType2[] res = (EnumType2[]) Common.ReadTest(engine, @"Good\EnumConverter3.txt");
