...
namespace FileHelpers
{
    internal class Messages
    {
        ...
        {
            private static readonly TypesOfMessages.Errors.FieldOptionalClass mFieldOptional =
                new TypesOfMessages.Errors.FieldOptionalClass();
            ...
            private static readonly TypesOfMessages.Errors.InvalidIdentifierClass mInvalidIdentifier =
                new TypesOfMessages.Errors.InvalidIdentifierClass();
            ...
            private static readonly TypesOfMessages.Errors.EmptyClassNameClass mEmptyClassName =
                new TypesOfMessages.Errors.EmptyClassNameClass();
            ...
            private static readonly TypesOfMessages.Errors.EmptyFieldNameClass mEmptyFieldName =
                new TypesOfMessages.Errors.EmptyFieldNameClass();
            ...
            private static readonly TypesOfMessages.Errors.EmptyFieldTypeClass mEmptyFieldType =
                new TypesOfMessages.Errors.EmptyFieldTypeClass();
            ...
            private static readonly TypesOfMessages.Errors.ClassWithOutRecordAttributeClass mClassWithOutRecordAttribute
                = new TypesOfMessages.Errors.ClassWithOutRecordAttributeClass();
            ...
            private static readonly TypesOfMessages.Errors.ClassWithOutDefaultConstructorClass
                mClassWithOutDefaultConstructor = new TypesOfMessages.Errors.ClassWithOutDefaultConstructorClass();
            ...
            private static readonly TypesOfMessages.Errors.ClassWithOutFieldsClass mClassWithOutFields =
                new TypesOfMessages.Errors.ClassWithOutFieldsClass();
            ...
            private static readonly TypesOfMessages.Errors.ExpectingFieldOptionalClass mExpectingFieldOptional =
                new TypesOfMessages.Errors.ExpectingFieldOptionalClass();
            ...
            private static readonly TypesOfMessages.Errors.SameFieldOrderClass mSameFieldOrder =
                new TypesOfMessages.Errors.SameFieldOrderClass();
            ...
            private static readonly TypesOfMessages.Errors.PartialFieldOrderClass mPartialFieldOrder =
                new TypesOfMessages.Errors.PartialFieldOrderClass();
            ...
            private static readonly TypesOfMessages.Errors.MissingFieldArrayLenghtInNotLastFieldClass
                mMissingFieldArrayLenghtInNotLastField =
                    new TypesOfMessages.Errors.MissingFieldArrayLenghtInNotLastFieldClass();

            internal static TypesOfMessages.Errors.MissingFieldArrayLenghtInNotLastFieldClass
                MissingFieldArrayLenghtInNotLastField
            {
                get { return mMissingFieldArrayLenghtInNotLastField; }
            }

            private static readonly TypesOfMessages.Errors.SameMinMaxLengthForArrayNotLastFieldClass
                mSameMinMaxLengthForArrayNotLastField =
                    new TypesOfMessages.Errors.SameMinMaxLengthForArrayNotLastFieldClass();

            internal static TypesOfMessages.Errors.SameMinMaxLengthForArrayNotLastFieldClass
                SameMinMaxLengthForArrayNotLastField
            {
                get { return mSameMinMaxLengthForArrayNotLastField; }
            }

            private static readonly TypesOfMessages.Errors.FieldNotFoundClass mFieldNotFound =
                new TypesOfMessages.Errors.FieldNotFoundClass();
            ...
            private static readonly TypesOfMessages.Errors.WrongConverterClass mWrongConverter =
                new TypesOfMessages.Errors.WrongConverterClass();
            ...
            private static readonly TypesOfMessages.Errors.NullRecordClassClass mNullRecordClass =
                new TypesOfMessages.Errors.NullRecordClassClass();
            ...
            private static readonly TypesOfMessages.Errors.StructRecordClassClass mStructRecordClass =
                new TypesOfMessages.Errors.StructRecordClassClass();
            ...
            private static readonly TypesOfMessages.Errors.TestQuoteClass mTestQuote =
                new TypesOfMessages.Errors.TestQuoteClass();
            ...
            private static readonly TypesOfMessages.Errors.MixOfStandardAndAutoPropertiesFieldsClass
                mMixOfStandardAndAutoPropertiesFields =
                    new TypesOfMessages.Errors.MixOfStandardAndAutoPropertiesFieldsClass();

            internal static TypesOfMessages.Errors.MixOfStandardAndAutoPropertiesFieldsClass
        ...
        internal class Errors
        {
            ...
            internal class MixOfStandardAndAutoPropertiesFieldsClass : MessageBase
            {
                internal MixOfStandardAndAutoPropertiesFieldsClass()
                    : base(
                        @"You must only use all standard fields or all automatic properties. You cannot mix them like in the $ClassName$ class."
                        ) {}
            ...
            internal class SameFieldOrderClass : MessageBase
            {
                internal SameFieldOrderClass()
                    : base(
                        @"The field: $FieldName1$ has the same FieldOrder that: $FieldName2$ you must use different values"
                        ) {}
