...
namespace FileHelpers
{
        ...
        where T : class
    {
            ...
            : base(typeof(T), encoding)
        {
            ...
            RecordInfo.Operations.ExtractFieldError += ExtractFieldError;
        }
        ...
        #region "  Events  "
        bool ExtractFieldError(object sender, ExtractFieldErrorEventArgs e)
        {
            switch (mErrorManager.ErrorMode)
            {
                ...
                case ErrorMode.SaveAndContinue:
                    // Add the error to the manager and continue processing the record
                    var err = new ErrorInfo
                    {
                        mLineNumber = e.LineNumber,
                        mExceptionInfo = e.Exception,
                        mRecordString = e.Line,
                    };
